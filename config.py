...
WANDB_GROUP = "whisper-minang-CV-freeze-encoder"

# =============================================================================
# MODEL CONFIGURATION
# =============================================================================
MODEL_NAME = "openai/whisper-base"
LANGUAGE = "indonesian"  # For Whisper generation (closest to Minangkabau)
...
# =============================================================================
SAMPLE_RATE = 16000
MIN_DURATION_SECONDS = 0.0  # No minimum - include all audio
...
# Training arguments (with regularization to prevent overfitting)
TRAINING_ARGS = {
    ...
    "learning_rate": 1e-5,
    "warmup_steps": 50,
    "max_steps": 200,  # ~50 epochs (reduced to prevent overfitting)
...
# Model dropout configuration (to be applied in trainer.py)
...
# =============================================================================
# AUGMENTATION CONFIGURATION (stronger to prevent overfitting)
# =============================================================================
AUGMENTATION_CONFIG = {
    "speed_perturbation": [0.85, 0.9, 0.95, 1.0, 1.05, 1.1, 1.15],  # More variety
    "noise_snr_range": (10, 25),  # Lower SNR = more noise
    "specaugment_time_mask": 100,  # Increased from 70
    "specaugment_freq_mask": 40,  # Increased from 27
}
